...
const scripts: MasterAlchemRouteScript[] = [
  ...
  },
  {
    ...
    label: "Redox Transfer Kitchen",
    mood: "labGuide",
    message: "Watch Paati's murukku story, then follow the electrons from zinc to copper ion.",
    nextLabel: "Open the redox lab",
    nextHref: "/labs/redox-transfer-kitchen",
    explainPrompt: "Guide me through oxidation, reduction, and redox agents.",
  },
  {
