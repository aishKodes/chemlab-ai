...
final class AdminCrudController
{
    private const ENTITY_CONFIG = [
        ...
        'resources' => [
            ...
            'listKey' => 'resources',
            'fields' => ['class_id', 'subject_id', 'chapter_id', 'topic_id', 'type', 'title', 'slug', 'description', 'route_url', 'content_json', 'source_type', 'source_reference', 'status'],
            'filters' => ['class_id', 'subject_id', 'chapter_id', 'topic_id', 'type', 'status', 'source_type'],
    ...
    {
        return $this->statusAction($request, 'resources', (int) ($params['id'] ?? 0), 'published');
    }
