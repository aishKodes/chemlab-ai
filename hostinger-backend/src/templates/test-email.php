...
/** @var array $data */
$message = htmlspecialchars((string) ($data['message'] ?? 'Chemlab email test.'), ENT_QUOTES, 'UTF-8');
?>
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Chemlab Email Test</title>
  </head>
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:18px;padding:28px;border:1px solid #d8eef8;">
            <tr>
              <td>
                <p style="margin:0 0 8px;font-size:13px;letter-spacing:.12em;text-transform:uppercase;color:#087ea4;font-weight:700;">Chemlab</p>
